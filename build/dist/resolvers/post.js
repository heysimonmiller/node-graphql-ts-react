...
let PostResolver = class PostResolver {
    ...
    post(id, // @Args("id") id is the changing the name in the schema.  post(id: 12) { title }
    { em }) {
        return em.findOne(Post_1.Post, { id });
    }
    //Mutation for updating, inserting, deleting (changing anything on server)
    createPost(title, // @Args("id") id is the changing the name in the schema.  post(id: 12) { title }
    { em }) {
